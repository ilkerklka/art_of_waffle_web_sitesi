...
<body>
    ...
    if (isset($_SESSION["admin"])) {
        ...
        <H3>Bize ulaşın metnini düzenleyin</H3>
        ...
        <div>
            ...
            <input type="checkbox" id="underlineCheck3">
        </div>
        <div class="  btn-group">
        ...
        <form action="" method="post">
            ...
            if (isset($_POST["bizeulasin"])) {
                ...
                if ($insert) {
                    echo '<div class="alert alert-success text-center"> Bize ulaşın metni başarıyla güncellendi başarıyla güncellendi . Site yenileniyor...</div>';
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="bizeulasin">
                <textarea style="height: 250px;" name="metin" class="form-control" id="myTextarea">
                    <?php if ($metinid = 2) {
                            $urungosterme = $baglan->prepare("SELECT * from metinler where id = '2' ");
