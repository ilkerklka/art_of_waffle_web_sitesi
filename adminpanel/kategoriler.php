    ...
    if (isset($_SESSION["admin"])) {
        ...
        <form action="" method="post">
            ...
            if (isset($_POST["kateg"])) {
                ...
                $urunekle = $baglan->prepare("INSERT INTO kategoriler set
            ...
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">KATEGORİ EKLEYİNİZ :</label>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sisteme Kayıtlı Kategoriler</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $formSorgu = $baglan->prepare("SELECT * FROM kategoriler ORDER BY id ASC");
                                        $formSorgu->execute();
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $kullanici['Kategoriler'] ?>
                                                </td>
                                                <td>
                                                   <a href="islemler/sil.php?id=<?php echo $kullanici['id']?>"> <div class="text-danger">sil</div></a>
                                                </td>
                                            </tr>
