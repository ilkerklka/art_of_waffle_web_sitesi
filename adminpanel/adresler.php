...
<body>
    ...
    if (isset($_SESSION["admin"])) {
        ...
        <div class="container">
            <div class="row">
                <div class="">
                <H3>Adres Ayrı Ekle</H3>
        <form action="" method="post">
            <?php
            if (isset($_POST["kateg"])) {
                $ilce        = @$_POST["ilce"];
                $mahalle        = @$_POST["mahalle"];
                $minucret        = @$_POST["minucret"];
                $urunekle = $baglan->prepare("INSERT INTO adres_ayar set
                ilce       =:ilce,
                mahalle    =:mahalle,
                minucret   =:minucret  ");
                ...
                if ($insert) {
                    echo '<div class="alert alert-success text-center">Adres başarıyla eklendi . Site yenileniyor...</div>';

                    echo '<meta http-equiv="refresh" content="2;URL=adresler.php">';
                }
            }
            ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ilce" placeholder="" class="form-control" id="Sifre" required>
                <label for="exampleInputPassword1" class="form-label">MAHALLE :</label>
                <input type="text" name="mahalle" placeholder="" class="form-control" id="Sifre" required>
                <label for="exampleInputPassword1" class="form-label">MİNİMUM ÜCRET :</label>
                <input type="number" name="minucret" placeholder="" class="form-control" id="Sifre" required>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sisteme Kayıtlı Adresler</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $formSorgu = $baglan->prepare("SELECT * FROM adres_ayar ORDER BY ilce ASC");
                                        $formSorgu->execute();

                                        while ($kullanici = $formSorgu->fetch(PDO::FETCH_ASSOC)) {
                                        ?>
                                            <tr>
                                                <td><?php echo $kullanici['ilce'] ?></td>
                                                <td>
                                                    <?php echo $kullanici['mahalle'] ?>
                                                </td>
                                                <td>
                                                    <?php echo $kullanici['minucret'] ?>
                                                </td>
                                                <td>
                                                   <a href="islemler/adressil.php?id=<?php echo $kullanici['id']?>"> <div class="text-danger">sil</div></a>
                                                </td>
                                            </tr>
