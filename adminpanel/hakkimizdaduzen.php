...
<body>
    ...
    if (isset($_SESSION["admin"])) {
        ...
        <H3>Hakkımızda metnini düzenleyin</H3>
        ...
        <form action="" method="post">
            ...
            if (isset($_POST["hakkimizda"])) {
                ...
                if ($insert) {
                    echo '<div class="alert alert-success text-center"> Hakkımızda metni başarıyla güncellendi başarıyla güncellendi . Site yenileniyor...</div>';
            ...
            <div class="mb-3">
                ...
                <input type="hidden" name="hakkimizda">
