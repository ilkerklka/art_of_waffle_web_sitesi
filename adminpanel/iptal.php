...
<body>
    ...
    if (isset($_SESSION["admin"])) {
        ...
        <H3>İptal Sebebi Ekle</H3>
        <form action="" method="post">
            <?php
            if (isset($_POST["kateg"])) {
                $kategori        = @$_POST["kategori"];
                $urunekle = $baglan->prepare("INSERT INTO iptalsebepleri set
                sebep       =:kategori ");
                ...
                if ($insert) {
                    echo '<div class="alert alert-success text-center">Kategori başarıyla güncellendi . Site yenileniyor...</div>';

                    echo '<meta http-equiv="refresh" content="2;URL=iptal.php">';
                }
            }
            ?>
            ...
            <div class="mb-3">
                <label for="exampleInputPassword1" class="form-label">SEBEP EKLEYİNİZ :</label>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Sisteme Kayıtlı İptal Sebebleri</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <?php
                                        $formSorgu = $baglan->prepare("SELECT * FROM iptalsebepleri ORDER BY id ASC");
                                        $formSorgu->execute();
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo $kullanici['sebep'] ?>
                                                </td>
                                                <td>
                                                    <a href="islemler/iptalsil.php?id=<?php echo $kullanici['id'] ?>">
